                    ...
                    <div class="card-body p-4">
                        <div class="d-flex mb-4">
                            <div class="flex-grow-1">
                                <span class="d-block mb-1">Laba / Rugi</span>
                                <h4 class="fs-20 mb-0">Rp 531,200</h4>
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ms-2 fs-12">1 Bulan lalu</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xxl-3">
                <div class="card border-0 rounded-3 bg-white mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex mb-4">
                            <div class="flex-grow-1">
                                <span class="d-block mb-1">Kredit</span>
                                <h4 class="fs-20 mb-0">Rp 2,251,952</h4>
                            </div>
                            <div class="flex-shrink-0 ms-3">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex mb-4">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="fs-20 mb-0">8,015,990</h4>
                            </div>
                            <div class="flex-shrink-0 ms-3">
            ...
            <div class="col-sm-6 col-xxl-3">
                <div class="card border-0 rounded-3 bg-white mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex mb-4">
                            <div class="flex-grow-1">
                                <span class="d-block mb-1">Beban</span>
                                <h4 class="fs-20 mb-0">Rp 7,114,580</h4>
                            </div>
                            <div class="flex-shrink-0 ms-3">
